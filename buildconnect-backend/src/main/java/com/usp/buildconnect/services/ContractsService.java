...
public class ContractsService {
	...
	public Contract createContract(ContractCreateDTO dto) {
		...
		com.usp.buildconnect.entity.Servico service = serviceRepository.findById(dto.getService_id())
	...
	public Contract updateContract(String status, Long id) {
		...
		if (this.mapStatus.get(status) - mapStatus.get(contract.getStatus()) != 1)
			throw new IllegalArgumentException("Invalid Status Transaction");
